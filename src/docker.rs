...
pub fn run(
    ...
    docker
        ...
        .args(&["sh", "-c", &format!("PATH=$PATH:/rust/bin:/cargo/bin echo $PATH && echo \"ls -al /cargo\" && ls -al /cargo && echo \"ls -al /cargo/bin\" && ls -al /cargo/bin && echo \"ls -al /rust\" && ls -al /rust && echo \"{:?}\" && {:?}", cmd, cmd)])
